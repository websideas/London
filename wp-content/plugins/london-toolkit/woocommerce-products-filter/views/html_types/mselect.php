...
?>
<select class="woof_mselect" data-placeholder="<?php echo WOOF_HELPER::wpml_translate($taxonomy_info->label) ?>" multiple="" size="<?php echo($this->is_woof_use_chosen() ? 1 : '') ?>" name="<?php echo $tax_slug ?>">
