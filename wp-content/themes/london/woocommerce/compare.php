 ...
 */
 ...
 USE THEME STYLE
 REMOVE LINE CODE file wp-content/plugins/yith-woocommerce-compare/class.yith-woocompare-frontend.php :
...
//var_dump( $wp_filter['wp_print_styles'] );
//var_dump( function_exists('kt_option') );
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($){
        ...
        $('body').on( 'yith_woocompare_render_table', function(){
            if( $( window ).width() > 767 ) {
                var  wh = $( window ).height() - $('.compare-title').height();
