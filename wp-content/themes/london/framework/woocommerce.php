...
function theme_share_product_add_share(){ 
    ...
    <div class="product-details-share clearfix">
        <ul class="share clearfix">
            <li><a href="mailto:?subject=<?php echo urlencode(get_the_title($post->ID)); ?>&amp;body=<?php echo urlencode(get_permalink($post->ID)); ?>"><i class="fa fa-envelope"></i> <?php _e('Print', THEME_LANG) ?></a></li>
            <li><a href="javascript:print();"><i class="fa fa-print"></i> <?php _e('Send to a friend', THEME_LANG) ?></a></li>
        </ul>
        <?php if($addthis_id){ ?>
