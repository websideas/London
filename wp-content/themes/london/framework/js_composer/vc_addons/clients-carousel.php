    ...
    protected function content($atts, $content = null) {
        ...
        $output .= '<div class=" '.$el_class.'">';
            ...
            $output .= ($title) ? '<h3 class="'.esc_attr($heading_class).'">'.$title.'</h3>' : '';
                ...
                $output .= '<div class="owl-carousel kt-owl-carousel" data-autoplay="true" data-pagination="false" data-theme="style-navigation-center visiable-navigation" data-itemscustom="[[992,'.$desktop.'], [768, '.$tablet.'], [480, '.$mobile.']]">';
                    $output .= $carousel;
                $output .= '</div>';
                $output .= '</div>';
